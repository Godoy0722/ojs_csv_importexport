...
class InvalidRowValidations
{
     ...
     * @throws RowValidationException
     */
    public static function validateJournalIsValid(?Journal $journal, string $journalPath): void
    {
        if (!$journal) {
     ...
     * @throws RowValidationException
     */
    public static function validateJournalLocale(Journal $journal, string $locale): void
    {
     ...
     * @throws RowValidationException
     */
    public static function validateUserGroupId(?int $userGroupId, string $journalPath): void
    {
        if (!$userGroupId) {
